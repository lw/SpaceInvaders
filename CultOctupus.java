...
public class CultOctupus extends CultEnemy {
	...
	public CultOctupus () {
		...
		state_1.lineTo (-2.0, -3.0);
		state_1.lineTo (-1.0, -3.0);
		state_1.lineTo (-1.0, -4.0);
		state_1.closePath ();
		
		state_2.moveTo (1.0, -4.0);
		state_2.lineTo (1.0, -3.0);
		state_2.lineTo (2.0, -3.0);
		state_2.lineTo (2.0, -2.0);
		state_2.lineTo (3.0, -2.0);
		state_2.lineTo (3.0, -1.0);
		state_2.lineTo (4.0, -1.0);
		state_2.lineTo (4.0, 0.0);
		state_2.lineTo (2.0, 0.0);
		state_2.lineTo (2.0, -1.0);
		...
		state_2.lineTo (1.0, 4.0);
		state_2.lineTo (1.0, 3.0);
		state_2.lineTo (4.0, 3.0);
		state_2.lineTo (4.0, 4.0);
		state_2.lineTo (3.0, 4.0);
		state_2.lineTo (3.0, 2.0);
